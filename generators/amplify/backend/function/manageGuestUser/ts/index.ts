...
const USERTABLE_NAME = process.env.API_SERVERLESSNINJAGRAPHQL_GUESTUSERTABLE_NAME;
if (!USERTABLE_NAME) {
  throw new Error("Function requires environment variable: 'API_SERVERLESSNINJAGRAPHQL_GUESTUSERTABLE_NAME'");
}
