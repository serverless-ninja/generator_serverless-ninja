...
const USERTABLE_NAME = process.env.API_POURBOIRGRAPHQL_ENDUSERTABLE_NAME;
if (!USERTABLE_NAME) {
  throw new Error("Function requires environment variable: 'API_POURBOIRGRAPHQL_ENDUSERTABLE_NAME'");
}
